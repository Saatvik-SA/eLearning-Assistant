...
def agentic_router(user_input):
    ...
    if "study plan" in user_input or "planner" in user_input:
        ...
        export_graded_report_to_pdf(graded, filename="Data/Output/Graded_paper.pdf")
...
if __name__ == "__main__":
    ...
    print("Ask me to do something (e.g., 'create study plan', 'grade answers', 'generate quiz', 'give answer key', or ask a question)\n")
